<?php $this->load->view('page_header')?>
  <div class="bungkus">
    ...
    <div class="example">
      <h2 class="bingung">Bingung Cari <span style="color: #00BCD4;">Tempat</span> Sewa?</h2>
      <h4 class="bingung2">Kami siap membantu Anda menemukan tempat sewa</h5>
  ...
  <div class="listTempat">
    <div class="labelTempat">
      <h2 class="labelReko1">Rekomendasi <span style="color: #00BCD4;">Tempat</span> untuk Anda</h2>
      <h4 class="labelReko2">Kami mencarikan tempat sewa yang terbaik untuk Anda</h4>
    </div>
  </div>
